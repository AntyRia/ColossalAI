...
def train_epoch(epoch: int, model: nn.Module, optimizer: Optimizer, criterion: nn.Module, train_dataloader: DataLoader,
    ...
    average_iterations_per_second_in_epoch = iterations_in_epoch / time_in_epoch  # 每个 epoch 的平均迭代速度

    print("当前epoch耗时：{}，迭代次数：{}，平均迭代速度：{}"
          .format(time_in_epoch, iterations_in_epoch, average_iterations_per_second_in_epoch))
...
def main():
   ...
   '''
    ...
    train_loader = DataLoader(train_dataset, batch_size=368, shuffle=True)
